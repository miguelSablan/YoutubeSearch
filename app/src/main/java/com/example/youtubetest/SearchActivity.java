...
import com.example.youtubetest.adapters.MovieAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private String YoutubeUrl1 = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=";
    private String YoutubeUrl2 = "&type=video&key=AIzaSyBNC0ZjzuuV8jYUD9cS9r1BCs4uC4YGWWg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputBtn = (EditText) findViewById(R.id.input_query);
